...
for it in range(iterations):
    ...
    #x_test = np.concatenate([x_test, zero_test])
    #y_test = np.concatenate([y_test, zero_test_y])
...
#1]))
    ...
    print('Round validation ROCAUC, accuracy, recall, precision', roc_auc_score(y_test, y_pred), accuracy_score(y_test, xg_predictions), recall_score(y_test, xg_predictions), precision_score(y_test, xg_predictions))
